                    ...
                    <>
                        ...
                        <div style={ { position: 'relative', maxWidth: '640px', margin: '0 auto', textAlign: 'center' } }>
                            ...
                            <p style={ { color: 'rgba(255,255,255,0.80)', fontSize: '1rem', lineHeight: 1.7, margin: '0 0 1.75rem' } }>
                                { subtext || 'Flexible payment options to fit your budget.' }
                            </p>
                            <span style={ {
                            ...
                            <p style={ { color: 'rgba(255,255,255,0.50)', fontSize: '11px', marginTop: '12px', marginBottom: 0 } }>
                    ...
                    <>
                        ...
                        <div style={ {
                            ...
                            <div style={ { flexShrink: 0 } }>
                                ...
                                <p style={ { color: '#888', fontSize: '11px', marginTop: '8px', marginBottom: 0, textAlign: 'center' } }>
                                    Subject to credit approval.
                                </p>
                            </div>
                        </div>
